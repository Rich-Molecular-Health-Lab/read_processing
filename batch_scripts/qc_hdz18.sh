...
#SBATCH --job-name=qc_hdz18
#SBATCH --error=/work/richlab/aliciarich/bioinformatics_stats/logs/qc_hdz18_%A_%a.err
#SBATCH --output=/work/richlab/aliciarich/bioinformatics_stats/logs/qc_hdz18_%A_%a.out
