...
Run the chunk below and then copy and paste the text that it creates to replace the text in the file `batch_scripts/qc_multiplex_remote.sh`
...
```{terminal, warning = FALSE}
cd read_processing
sbatch batch_scripts/qc_multiplex_remote.sh
```
